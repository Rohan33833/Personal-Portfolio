...
export const PORTFOLIO_DATA = {
  ...
  stats: [
    { label: "Status Badge", value: "Student", desc: "CS & Engg Intern", isBadge: true },
    { label: "Certifications", value: "4", desc: "AWS, Anthropic, Deloitte, CBA" },
    { label: "Projects Shipped", value: "7", desc: "Full-Stack, Mobile & Embedded" },
    { label: "Hardware Built", value: "1", desc: "Quadcopter from Frame Up" }
  ],
  ...
  skills: [
    {
      ...
      skills: [
        ...
        { name: "Flutter", level: "Advanced", icon: "Smartphone" },
        { name: "Android / Dart", level: "Intermediate", icon: "Tablet" },
        { name: "HTML5 / CSS3 / JS", level: "Advanced", icon: "Layout" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "WebSockets", level: "Advanced", icon: "Zap" },
        { name: "C++ / C (Arduino)", level: "Intermediate", icon: "Cpu" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "MongoDB", level: "Advanced", icon: "FileText" },
        { name: "Redis", level: "Intermediate", icon: "Layers" },
        { name: "Firebase", level: "Advanced", icon: "Flame" },
        { name: "Supabase", level: "Intermediate", icon: "Database" },
        { name: "SQL", level: "Advanced", icon: "Terminal" }
      ]
    },
    {
      category: "Security & DevOps",
      skills: [
        { name: "JWT Auth", level: "Advanced", icon: "Shield" },
        { name: "Single Sign-On (SSO)", level: "Intermediate", icon: "Lock" },
        { name: "Git / GitHub", level: "Advanced", icon: "GitBranch" },
        { name: "Cyber Security", level: "Intermediate", icon: "ShieldCheck" },
        { name: "Cryptography", level: "Intermediate", icon: "Key" }
      ]
    }
  ],
  ...
  projects: [
    {
      ...
      category: "Full-Stack",
      isFlagship: true,
      tech: ["Flutter", "Node.js", "PostgreSQL", "Redis", "Firebase"],
    ...
    },
    {
      ...
      category: "Full-Stack",
      isFlagship: true,
      tech: ["React", "Node.js", "MongoDB", "JWT", "Razorpay", "MSAL", "Recharts"],
    ...
    },
    {
      ...
      isFlagship: true,
      tech: ["Arduino", "C++", "Flight Controller", "ESC Calibration", "Custom Wiring"],
    ...
    },
    {
      ...
      category: "Mobile",
      tech: ["Flutter", "Dart", "MongoDB", "Geolocation", "Background Services"],
    ...
    },
    {
      ...
      category: "Mobile",
      tech: ["Flutter", "Dart", "MongoDB", "GPS APIs", "Google Maps"],
    ...
    },
    {
      ...
      category: "Mobile",
      tech: ["Flutter", "Dart", "Supabase", "QR Scanner", "SQL"],
  ...
  highlights: [
    {
      ...
      tags: ["PostgreSQL", "Redis", "Advisory Locks", "Concurrency"]
    },
    {
      ...
      tags: ["JWT", "MSAL SSO", "Razorpay Webhooks", "HMAC-SHA256"]
    }
  ],
